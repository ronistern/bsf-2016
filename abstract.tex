...
data-driven methods are usually used observations of past activities are given instead of such a model. % and model-based methods are used when a reliable model of the world is given and are usually applied suited for different settings. 
